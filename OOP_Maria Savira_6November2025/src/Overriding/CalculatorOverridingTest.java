...
public class CalculatorOverridingTest { 
    ...
    public void testOverriding() { 
        ...
        CalculatorOverriding calculatorOverridingScientific = new 
        CalculatorOverriding.ScientificCalculator(); 
        double codeInputA = 10; 
        double codeInputB = 0; 
        // --- Execution / code output --- 
        // Memanggil method getType() dan divide() dari masing-masing objek
        ...
        // --- Expected output --- 
        // Nilai hasil yang diharapkan untuk masing-masing pengujian
        ...
        try { 
            ...
            assertEquals("divide(10,0) for ScientificCalculator:", expectedOutputDivideSci, codeOutputDivideSci, 0.0001); 
        } catch (AssertionError ae) { 
            System.out.println(ae); // Menampilkan error jika hasil tidak sesuai
        } 
    } 
} 